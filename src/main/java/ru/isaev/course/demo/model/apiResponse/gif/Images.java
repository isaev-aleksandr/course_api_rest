...
public class Images {
    ...
    @JsonProperty("480w_still")
    public ru.isaev.course.demo.model.apiResponse.gif._480wStill get480wStill() {
        return _480wStill;
    }

    @JsonProperty("480w_still")
    public void set480wStill(ru.isaev.course.demo.model.apiResponse.gif._480wStill _480wStill) {
